        ...
        <div class="container">
            <div class="formContainer">
                ...
                <form action="index.php?controller=Product&action=registerProduct" method="post" id="productForm" enctype="multipart/form-data">
                    <div class="formColumn">
                        <div class="formRow">
                            ...
                            <input type="text" id="name" name="name" required min="2" aria-required="true" tabindex="<?php echo $tabindex++; ?>">
                        </div>

                        <div class="formRow">
                            <label for="description" aria-label="Product description">Description:</label>
                            <textarea id="description" name="description" rows="4" required aria-required="true" tabindex="<?php echo $tabindex++; ?>"></textarea>
                        </div>
                    ...
                    <div class="formColumn">
                        ...
                        <div class="formRow">
                            ...
                            <select id="category" name="id_category" required aria-required="true" tabindex="<?php echo $tabindex++; ?>">
                        ...
                        <div class="formRow">
                            ...
                            <input type="number" id="price" name="price" min="1" step="1" required aria-required="true" tabindex="<?php echo $tabindex++; ?>">
                        </div>

                        <div class="formRow">
                            <label for="storage" aria-label="Product storage">Storage:</label>
                            <input type="number" id="storage" name="storage" min="0" required aria-required="true" tabindex="<?php echo $tabindex++; ?>">
                        </div>

                        <div class="formRow">
                            <label for="memory" aria-label="Product memory">Memory:</label>
                            <input type="number" id="memory" name="memory" min="0" required aria-required="true" tabindex="<?php echo $tabindex++; ?>">
                        </div>

                        <div class="formRow">
                            <label for="stock" aria-label="Product stock">Stock:</label>
                            <input type="number" id="stock" name="stock" min="0" required aria-required="true" tabindex="<?php echo $tabindex++; ?>">
                        </div>

                        <div class="formRow">
                            <label for="colors" aria-label="Product colors">Colors:</label>
                            <input type="text" id="colors" name="colors" placeholder="#FFFFFF, #000000, #FF00FF..." title="Write each color code separated with commas as shown in the example" required aria-required="true" tabindex="<?php echo $tabindex++; ?>">
                        </div>
                        ...
                        <div class="formRow">
                            ...
                            <select id="featured" name="featured" required aria-required="true" tabindex="<?php echo $tabindex++; ?>">
                        ...
                        <div class="formRow">
                            ...
                            <select id="isactive" name="isactive" required aria-required="true" tabindex="<?php echo $tabindex++; ?>">
                                <option value="true" tabindex="<?php echo $tabindex++; ?>">True</option>
                                <option value="false" tabindex="<?php echo $tabindex++; ?>">False</option>
                            </select>
                        </div>
                ...
                <div class="formAction">
                    <button type="submit" value="Add Product" class="addBtn" form="productForm" tabindex="<?php echo $tabindex++; ?>">Add product</button>
                </div>
            </div>
        </div>
    </main>
