        ...
        <main>
            ...
            <div class="container">
                <div class="formContainer">
                    <h2>Edit Product</h2>
                    <form action="index.php?controller=Product&action=updateProduct" method="post" id="productForm"
                        ...
                        <div class="formColumn">
                            ...
                            <div class="formRow">
                                ...
                                <input type="text" id="colors" name="colors"
                                    value="<?php print(implode(", ", $product->getColors())); ?>"
                    ...
                    <div class="formAction">
                        <a href="index.php?controller=Product&action=showEditProducts" class="cancelBtn"
                            aria-label="Cancel and revert changes" tabindex="<?php echo $tabindex++; ?>">Cancel</a>
                        <button type="submit" form="productForm" class="addBtn"
                            aria-label="Update and confirm product information update"
                            tabindex="<?php echo $tabindex++; ?>">Update</button>
                    </div>
                </div>
            </div>
        </main>
