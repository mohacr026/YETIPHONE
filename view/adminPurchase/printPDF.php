...
$content .= '<tr><th>Shipment direction:</th><td>'.$purchaseData->getShipmentDirection().'</td></tr>';
$content .= '<tr><th>Shipment province:</th><td>'.$purchaseData->getProvince().'</td></tr>';
$content .= '<tr><th>Shipment city:</th><td>'.$purchaseData->getCity().'</td></tr>';
$content .= '<tr><th>Shipment zip code:</th><td>'.$purchaseData->getZipCode().'</td></tr>';
$content .= '</table>';
$content .= '</td></tr></table>';
