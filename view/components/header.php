...
<input type="checkbox" id="menuBtn" class="menu-button-checkbox">
    ...
    <a href="index.php" style="text-decoration: none" aria-label="YETiPhone" tabindex='50'>
        <h1>YETiPhone</h1>
    <a>
    <button id="categoriasBtn" style="text-decoration: none" class="categorias" aria-expanded="false" aria-haspopup="true" aria-controls="categoriasDropdown" tabindex="5">
    ...
    <div id="categoriasDropdown" class="categorias-dropdown" aria-labelledby="categoriasBtn">
        ...
        $index = 10;
        foreach ($categories as $category): ?>
            <a href="index.php?controller=Product&action=showProducts&category=<?= $category->getId(); ?>" tabindex="<?php $index++ ?>"><?= $category->getName(); ?></a>
        <?php endforeach; ?>
    </div>
    ...
    <div class="searchBar">
        ...
        <input type="" placeholder="Search any product..." id="search" tabindex="0">
    ...
    <div class="icons">
        <?php
            if(!isset($_SESSION['email'])) {
                echo "<a class='button' href='index.php?controller=User&action=showLoginForm' tabindex='2'>";
                ...
                if($_SESSION['role'] == "admin"){
                    ...
                    echo "  <a href='index.php?controller=User&action=showAdminDashboard' tabindex='3'>Dashboard</a>";
                    echo "  <a>elemento</a>";
                    echo "  <div class='dropdownDivider'></div>";
                    echo "  <a href='index.php?controller=User&action=logout' tabindex='4'>Log out</a>";
                    echo "</div>";
                } else {
