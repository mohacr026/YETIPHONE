...
<body>
    ...
    <div class="slider-container">
        ...
        <div class="banner" ontouchstart="handlePrincipalTouchStart(event)"
            ontouchmove="handlePrincipalTouchMove(event)">
            <img src="src/img/gif.gif" alt="">
        </div>

        <div class="slider-destacados" ontouchstart="handleDestacadosTouchStart(event)"
            ontouchmove="handleDestacadosTouchMove(event)">
            <div class="Tops">
                                ...
                                <div class="product">
                                    <div class="primeraFila">
                                        <div class="productImg">
                                            <img src="./src/img/products/<?php echo $product->getImage()[0]; ?>"
                                    ...
                                    <div class="info">
                                        <div class="gb">
                                            <p>
                                                <?php echo $product->getStorage(); ?> GB
                                            </p>
                                        </div>
                                        <div class="ram">
                                            <p>
                                                <?php echo $product->getMemory(); ?> RAM
                                            </p>
                                        </div>
                                        <div class="carrito">
    ...
    <a href="index.php?controller=Product&action=showProductPage&id=<?php echo $product->getId(); ?>">
        <div class="contenido-extra">
            <div class="texto-extra">
                ...
                <p>Descubre aquí las mejores promociones en telefonos de Xiaomi para ti.</p>
                <button class="vermas">ver mas</button>
            </div>
            <div class="imagen-extra">
                <!-- <img src="src/img/xiaomi.jpg" alt="xiaomi"> -->
            </div>
        </div>
    </a>
            ...
            <div class="redes">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                    <g clip-path="url(#clip0_411_68)">
                        <path
                            d="M30 15.1824C30 22.7142 24.5075 28.9582 17.3375 30.0912V19.574H20.8237L21.4875 15.2227H17.3375V12.3994C17.3375 11.2084 17.9175 10.0489 19.775 10.0489H21.6613V6.34403C21.6613 6.34403 19.9487 6.04975 18.3125 6.04975C14.895 6.04975 12.6625 8.13359 12.6625 11.9051V15.2214H8.86375V19.5727H12.6625V30.09C5.49375 28.9556 0 22.7129 0 15.1824C0 6.84832 6.71625 0.0912476 15 0.0912476C23.2838 0.0912476 30 6.84706 30 15.1824Z"
                            fill="white" />
                    </g>
                    <defs>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                    <g clip-path="url(#clip0_411_76)">
                        <path
                            ...
                            fill="white" />
                        <path
                            d="M15 7.29749C10.7462 7.29749 7.29749 10.7462 7.29749 15C7.29749 19.2537 10.7462 22.7025 15 22.7025C19.2537 22.7025 22.7025 19.2537 22.7025 15C22.7025 10.7462 19.2537 7.29749 15 7.29749ZM15 20C12.2387 20 9.99999 17.7612 9.99999 15C9.99999 12.2387 12.2387 9.99999 15 9.99999C17.7612 9.99999 20 12.2387 20 15C20 17.7612 17.7612 20 15 20Z"
                            fill="white" />
                        <path
                            d="M23.0075 8.7925C24.0016 8.7925 24.8075 7.98662 24.8075 6.9925C24.8075 5.99839 24.0016 5.1925 23.0075 5.1925C22.0134 5.1925 21.2075 5.99839 21.2075 6.9925C21.2075 7.98662 22.0134 8.7925 23.0075 8.7925Z"
                            fill="white" />
                    </g>
                    <defs>
